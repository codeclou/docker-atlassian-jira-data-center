...
#
####################################################################################
# keep in sync with 'manage-jira-cluster-8.0.1-version.txt'
...
JIRA_VERSION="8.0.1"
JIRA_VERSION_DOT_FREE="801"
JIRA_LB_PUBLIC_PORT=1801
...
# Kills and removes all jira-cluster-801-node* instances if present
#
#
...
function update_check {
    ...
    local latest_version=$(curl -s https://raw.githubusercontent.com/codeclou/docker-atlassian-jira-data-center/master/8.0.1/manage-jira-cluster-8.0.1-version.txt?r=${unique_hash})
...
echo -e $C_MGN'  https://github.com/codeclou/docker-atlassian-jira-data-center/tree/master/8.0.1'$C_RST
