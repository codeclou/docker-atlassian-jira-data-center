...
# Kills and removes all jira-cluster-830-node* instances if present
#
#
...
function update_check {
    ...
    local latest_version=$(curl -s https://raw.githubusercontent.com/codeclou/docker-atlassian-jira-data-center/master/8.3.0-m0003/manage-jira-cluster-8.3.0-m0003-version.txt?r=${unique_hash})
...
echo -e $C_MGN'  https://github.com/codeclou/docker-atlassian-jira-data-center/tree/master/8.3.0-m0003'$C_RST
