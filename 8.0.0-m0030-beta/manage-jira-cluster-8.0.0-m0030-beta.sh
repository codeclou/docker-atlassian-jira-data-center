...
#
####################################################################################
# keep in sync with 'manage-jira-cluster-8.0.0-m0030-beta-version.txt'
...
JIRA_VERSION="8.0.0-m0030-beta"
JIRA_VERSION_DOT_FREE="800"
JIRA_LB_PUBLIC_PORT=1800
...
# Kills and removes all jira-cluster-800-node* instances if present
#
#
...
function update_check {
    ...
    local latest_version=$(curl -s https://raw.githubusercontent.com/codeclou/docker-atlassian-jira-data-center/master/8.0.0-m0030-beta/manage-jira-cluster-8.0.0-m0030-beta-version.txt?r=${unique_hash})
...
echo -e $C_MGN'  https://github.com/codeclou/docker-atlassian-jira-data-center/tree/master/8.0.0-m0030-beta'$C_RST
