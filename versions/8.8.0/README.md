...
```
cp -R /opt/jira-cluster/8.8.0/jira-home-node1/{data,plugins,logos,import,export,caches} /opt/jira-cluster/8.8.0/jira-home-node2
```
...
```
cp -R /opt/jira-cluster/8.8.0/jira-home-node1/{data,plugins,logos,import,export,caches} /opt/jira-cluster/8.8.0/jira-home-node3
```
