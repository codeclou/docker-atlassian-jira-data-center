...
#
####################################################################################
# keep in sync with 'manage-jira-cluster-7.5.0-version.txt'
...
JIRA_VERSION="7.5.0"
JIRA_VERSION_DOT_FREE="750"
JIRA_LB_PUBLIC_PORT=60750
...
# Kills and removes all jira-cluster-750-node* instances if present
#
#
...
function update_check {
    ...
    local latest_version=$(curl -s https://raw.githubusercontent.com/codeclou/docker-atlassian-jira-data-center/master/7.5.0/manage-jira-cluster-7.5.0-version.txt?r=${unique_hash})
...
echo -e $C_MGN'  https://github.com/codeclou/docker-atlassian-jira-data-center/tree/master/7.5.0'$C_RST
